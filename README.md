...
This is a simplified example that demonstrates how to handle sessions with csrf tokens from a React frontend. It is not complete and therefore should not be used in production.
